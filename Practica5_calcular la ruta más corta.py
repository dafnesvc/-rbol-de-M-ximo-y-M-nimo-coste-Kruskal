...
algoritmo de Kruskal para determinar las rutas más eficientes para servicios, tanto para el Árbol de Mínimo Coste (MST) 
como para el Árbol de Máximo Coste."""
